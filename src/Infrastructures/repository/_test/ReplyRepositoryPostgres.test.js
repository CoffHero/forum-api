...
describe('ReplyRepositoryPostgres', () => {
  ...
  describe('verifyAvailableReplyById function', () => {
    it('should throw NotFoundError if reply not available', async () => {
      ...
      // Action & Assert
      await expect(replyRepositoryPostgres.checkingReplyById(replyId))
  ...
  describe('getRepliesByThreadId function', () => {
    it('should get replies by threadId correctly', async () => {
      ...
      expect(repliesResult[0].id_comment).toEqual(replyPayload.commentId)
      expect(repliesResult[0].del).toEqual(false)
    })
  ...
  describe('deleteReply function', () => {
    it('should return delete reply correctly', async () => {
      ...
      expect(replyResult[0].del).toEqual(true)
    })
  })
})
